...
/// Reversible history command for a completed Rectangle shape.
class RectangleCommand extends HistoryCommand {
  /// Creates a [RectangleCommand].
  RectangleCommand({
  ...
  @override
  String get name => 'Draw Rectangle';
